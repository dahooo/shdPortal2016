...
var fileContextRoot = '<%= renderRequest.getContextPath()+"/fileServlet"%>';
			...
			<article id="newsListContent" class="bc_content">
              	<table style="margin-top: 10px;width:100%;">
					<tr>
						<td align="right">	
							<input type="button" onclick="addNews();" class="bcButton" value="新增新聞" />		
						</td>
					</tr>
				</table>
                <section class="entry-container">
                    <h3 class="entry-title">企業新聞列表</h3>
...
<script src="<%= renderRequest.getContextPath()%>/js/addNewsJsScript.js" ></script>