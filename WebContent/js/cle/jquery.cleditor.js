...
(function ($) {
    ...
    $.cleditor = {
        ...
        defaultOptions: {
            ...
            controls:     // controls to add to the toolbar
                          ...
                          "image link unlink | print youtube",
            ...
            fonts:        // font names in the font popup
                          "微軟正黑體,Arial,Arial Black,Comic Sans MS,Courier New,Narrow,Garamond," +
    ...
    $.cleditor.buttons.youtube = {
        ...
        popupContent: "Enter Video Link:<br><input type=text size=40><br><input type=button value=Submit>",
    ...
    function youtubeClick(e, data) {
        ...
        .bind("click", function(e) {
            ...
            var link = $(data.popup).find(":text").val();
            var num = link.split("v=")[1];

            var html = '<iframe width="100%" height="350" src="https://www.youtube.com/embed/'+num+'" frameborder="0" allowfullscreen></iframe>';
